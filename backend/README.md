...
## Project Structure
    ...
    ├── testapiautocatalog_112781  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_112781`
...
2. Clone this repo and `cd testapiautocatalog_112781`
